...
/*
	IMPLEMENTING THE OPERATION OF THE strcpy() FUNCTION WITHOUT
...
{
	/*
		THIS FUNCTION ACCEPTS TWO STRINGS, COPIES THE SECOND STRING
		OVER THE FIRST STRING, AND RETURNS THE STARTING ADDRESS OF
		THE FIRST STRING. THE PREVIOUS CONTENT OF THE FIRST STRING
		(IF ANY) IS ERASED
	*/
